<x-layout :title="' - Supplier List '"> {{--Extends the layout page to this page--}}
    ...
    <div class="card fluid" tyle="margin:20px;">
            <div class="card-header">
               <!-- <form action="" class="row row-cols-auto g-1">
                    ...
                    <div class="col">
                        <a class="btn btn-primary float-right" href="{{route('supplier.create')}}"><i class="fas fa-plus"></i>
                        Add New</a>
                    </div>
                </form>
                      ...
                      <tr>
                        ...
                        <td>
                           ...
                           @endcan
                            ...
                            @can('supplier-delete')
                            <form action="{{ route('supplier.destroy', $supplier) }}" method="POST" style="display:inline;" onsubmit="return confirm('Delete?')">
                                @csrf
                                @method('DELETE')
