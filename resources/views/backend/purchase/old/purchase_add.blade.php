...
<div class="col-12">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-12">
                <label for="example-text-input" class="form-label">Purchase No</label>
                 <input class="form-control example-date-input" name="purchase_no" type="text"  id="purchase_no" value="{{ $purchase_no }}" readonly style="background-color:#ddd">
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Supplier Name (Select) </label>
