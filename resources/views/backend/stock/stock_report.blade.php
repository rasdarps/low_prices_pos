...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('stock.report.pdf') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"></i> Stock Report Print </a> <br>  <br>               
