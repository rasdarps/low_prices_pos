...
@section('title') {{'Stock Product Wise'}} @endsection
 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Category and Product Wise Report </h4>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <input type="radio" name="category_product_wise" value="category_wise" class="search_value"> &nbsp;&nbsp;
...
<!--  /// Supplier Wise  -->
    <div class="show_category" style="display:none">
        <form method="GET" action="{{ route('category.wise.pdf') }}" id="myForm" >
