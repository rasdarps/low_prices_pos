                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <span class="card-title" style="font-size:20px;">Create | Supplier </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="enter supplier name" onkeypress="return isCharKey(event)">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="city" name="city" class="form-control" value="{{ old('city') }}" placeholder="enter city" onkeypress="return isCharKey(event)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="type" id="type" class="form-control select2" aria-label="Select supplier type">
                                                    <option disabled selected value="">Select Supplier Type</option>
