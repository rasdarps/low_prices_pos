...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('invoice.approved.list') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-list"></i> Approved Inovice </a> <br>  <br>               

                    <h4 class="card-title">All Pending Inovice</h4>
