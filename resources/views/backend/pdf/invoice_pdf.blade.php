                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Invoice Print </h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_cart.png') }}" alt="logo" height="24"/> RICT Shopping Mall - Customer Invoice
                </h3>
            </div>
            <hr>
        ...
        <div class="col-12">
            <div>
                <div class="col-6 mt-4">
                    ...
                    <address>
                        <strong>Customer Name: {{ $payment['customer']['name'] }}</strong><br>
      ...
      @php
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">Gh¢{{ $payment->total_amount }}</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
