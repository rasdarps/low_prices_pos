    ...
    <div class="row">
        <div class="col-12">
            <div class="purchase-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_cart.png') }}" alt="logo" height="24"/> RICT Shopping Mall - Daily Purchase Invoice
                </h3>
            </div>
            <hr>
      ...
      @php
        ...
        <tr>
           ...
           <td class="text-center">{{ $item->purchase_no }}</td>
            ...
            <td class="text-center">{{ $item['purchase_payment']['supplier']['name'] }}</td>
            
            <td class="text-end">{{ $item['purchase_payment']['total_amount'] }}</td>
            
            
        </tr>
         @php
        $total_sum += $item['purchase_payment']['total_amount'];
        @endphp
        @endforeach
