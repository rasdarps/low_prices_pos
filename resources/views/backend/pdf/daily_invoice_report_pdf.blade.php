...
@section('title') {{'Daily Invoice Report'}} @endsection
@section('admin')
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_cart.png') }}" alt="logo" height="24"/> RICT Shopping Mall - Daily Sales Invoice
                </h3>
            </div>
            <hr>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-end"><strong>Amount(Gh¢)</strong></td>
      ...
      @php
        ...
        <tr>
           ...
           <td class="text-center">{{ $item->invoice_no }}</td>
            ...
            <td class="text-end">{{ $item['payment']['total_amount'] }}</td>
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">Gh¢{{ $total_sum}}</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
