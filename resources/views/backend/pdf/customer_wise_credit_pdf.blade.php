...
@section('title') {{'Credit Customer Wise Report'}} @endsection
@section('admin')
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_cart.png') }}" alt="logo" height="24"/> RICT Shopping Mall - Customer Wise Credit Report
                </h3>
            </div>
            <hr>
