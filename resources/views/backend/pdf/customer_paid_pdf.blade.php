...
@section('title') {{'Customer Payment Report'}} @endsection
@section('admin')
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo_cart.png') }}" alt="logo" height="24"/> RICT Shopping Mall - Customer Wise Payment Report
                </h3>
            </div>
            <hr>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-end"><strong>Due Amount(Gh¢)</strong>
            </td>
      ...
      @php
        ...
        <td class="text-end"> Gh¢{{ $item->due_amount }} </td> 
        ...
        @endforeach
            ...
            <tr>
                ...
                <td class="no-line text-end"><h4 class="m-0">Gh¢{{ $total_due}}</h4></td>
            </tr>
                            </tbody>
                        </table>
                    </div>
