...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <span style="font-size:20px;">Add Customer</span>
        </div>
        <div class="card-body">
  ...
  <div class="row mb-3">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
       <input name="customer_image" class="form-control" type="file"  id="image" value="{{ old('customer_image') }}">
                </div>
            </div>
            <!-- end row -->
   ...
   <img id="showImage" class="rounded avatar-lg" src="{{  url('upload/no_image.jpg') }}" alt="Card image cap">
            ...
            <center>
            <input type="submit" class="btn btn-info waves-effect waves-light text-center" value="Add Customer">
        </center>
    </form>
