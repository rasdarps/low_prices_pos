...
<head>
    ...
    <title>Low Prices POS | @yield('title')</title>

    {{-- <title>{{ config('app.name', 'RICT POS') }}</title> --}}
    <!-- Scripts -->
...
<style>
    body{
        ...
        background-image: linear-gradient(rgba(15, 17, 17, 0.9), rgba(12, 12, 12, 0.9)), url({{ asset('images/posbg1.jpg') }});
