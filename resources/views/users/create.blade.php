                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header with-border">
                            <span class="card-title" style="font-size:20px;">Create | User </span>
                                    ...
                                    <div class="row col-md-10 mx-auto">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Full Name" onkeypress="return isCharKey(event)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="username" name="username" class="form-control" value="{{ old('username') }}" placeholder="Username" onkeypress="return isCharKey(event)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="phone" name="phone" class="form-control" value="{{ old('phone') }}" placeholder="Phone"  pattern="\d{10}" maxlength="10" minlength="10" onkeypress="return isNumberKey(event)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                {{-- <small class="form-text text-muted" style="color:red !important">Password must have a minimum of 6 characters, atleast 1 capital, 1 small letter and 1 symbol..</small> --}}

                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="confirm_password"><strong>Confirm Password: <span class="text-danger">*</span></strong></label>
